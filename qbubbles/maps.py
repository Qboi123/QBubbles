...
class ClassicMap(GameMap):
    ...
    def on_save(self, evt: SaveEvent):
        ...
        #
        # sprite_info_file = NZTFile(f"{save_path}/spriteinfo.dill", "w")
        ...
        #     sprite_data_file = NZTFile(f"{save_path}/sprites/{sprite.replace(':', '/')}.dill", "w")
    ...
    def save_savedata(self, path):
        ...
        # sprite_info_file = NZTFile(f"{path}/spriteinfo.dill", "w")
        # sprite_info_file.data = sprite_info_data
        # sprite_info_file.save()
        # sprite_info_file.close()
